    ...
    <footer className="max_screen_width bg-secondary">
            ...
            >
              ...
              {index === 1 && (
                <LinkButton
                  ...
                  className="mt-6 w-full justify-center text-white bg-primary border-secondary"
                />
                // <OnlyButton
      ...
      <div className="bg-primary">
        <Container className="py-4">
          <div className="flex max-md:flex-col items-center justify-center gap-2 text-secondary md:text-lg">
            {" "}
            <p className="">© {new Date().getFullYear()} Manali Se</p>
