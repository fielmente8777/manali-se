...
const AboutSection: React.FC<AboutSectionProps> = ({
  ...
  return (
    <Section className="space-y-14">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[2fr_1.3fr_2fr] gap-6 ">
        <div className="relative w-full aspect-[4/3.5] border-primary border-t-12 border-r-[3px] rounded-tr-[200px] overflow-hidden">
        ...
        <div className="relative about-bg w-full aspect-[4/3.5]">
